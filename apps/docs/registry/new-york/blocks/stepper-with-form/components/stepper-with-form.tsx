	...
	return (
		<div className="space-y-4 text-start">
			<div className="space-y-2">
				...
				<Input id={register("address").name} {...register("address")} className="block w-full rounded-md border p-2" />
			...
			<div className="space-y-2">
				...
				<Input id={register("city").name} {...register("city")} className="block w-full rounded-md border p-2" />
	...
	return (
		<div className="space-y-4 text-start">
			...
			<div className="space-y-2">
				...
				<Input id={register("cvv").name} {...register("cvv")} className="block w-full rounded-md border p-2" />
...
const FormStepperComponent = () => {
	...
	const onSubmit = (values: z.infer<typeof methods.current.schema>) => {
		alert(`Form values for step ${methods.current.id}: ${JSON.stringify(values)}`);
	};
