...
<Callout type="info">
  Initially, the library is oriented to React, but it is expected that the community can contribute with implementations for other frameworks such as Vue, Angular, Solid, Svelte, etc.
</Callout>
...
<FAQBox title="Can I use Stepperize with Vue, Angular, Solid, Svelte, etc.?">
