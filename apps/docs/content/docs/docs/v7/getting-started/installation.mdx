...
```bash
pnpm add @stepperize/react@^7.0.0
```
...
```bash
npm install @stepperize/react@^7.0.0
```
...
```bash
yarn add @stepperize/react@^7.0.0
```
...
```bash
bun add @stepperize/react@^7.0.0
```
...
Next: [build your first stepper](/docs/v7/getting-started/first-stepper).
