...
see [Building forms with Stepperize](/docs/v7/forms).
...
adapters. See [Core utilities](/docs/v7/api/core/overview).
...
[Shared state](/docs/v7/guides/shared-state).
...
[Troubleshooting](/docs/v7/getting-started/troubleshooting#steppernext-is-disabled-on-the-last-step).
...
[Migrating to v7](/docs/v7/migration/v7).
