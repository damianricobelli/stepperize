...
- Use [Stepperize data](/docs/v7/forms/patterns#pattern-1--save-a-steps-values)
  when the review step or final submit needs every step's values.
- Use [controlled state](/docs/v7/core-concepts/controlled-vs-uncontrolled)
...
Next: review [form core patterns](/docs/v7/forms/patterns), [shared state](/docs/v7/guides/shared-state), or [navigation guards](/docs/v7/guides/navigation).
