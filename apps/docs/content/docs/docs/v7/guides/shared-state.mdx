...
[React Activity](/docs/v7/guides/react-activity) to preserve inactive step
...
Next: [build primitive UI](/docs/v7/guides/primitives), or jump to the [instance reference](/docs/v7/api/react/stepper-instance).
