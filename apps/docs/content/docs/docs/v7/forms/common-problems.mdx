...
pattern](/docs/v7/forms/patterns); most also appear in the general
[Troubleshooting](/docs/v7/getting-started/troubleshooting) page.
...
See [Pattern 3](/docs/v7/forms/patterns#pattern-3--validate-before-moving-forward).
...
[Pattern 1](/docs/v7/forms/patterns#pattern-1--save-a-steps-values).
...
See [Pattern 2](/docs/v7/forms/patterns#pattern-2--seed-a-step-from-its-draft).
If the problem is component-local state being destroyed by unmounts, use
[React Activity](/docs/v7/guides/react-activity) to keep inactive step
...
`goTo("review")`. See
[Pattern 5](/docs/v7/forms/patterns#pattern-5--edit-a-previous-step-then-return).
...
See [Status vs
completion](/docs/v7/core-concepts/status-vs-completion).
