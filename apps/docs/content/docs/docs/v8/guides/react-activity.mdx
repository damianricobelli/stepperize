...
- Use [Stepperize data](/docs/v8/forms/patterns#pattern-1--save-a-steps-values)
  when the review step or final submit needs every step's values.
- Use [controlled state](/docs/v8/core-concepts/controlled-vs-uncontrolled)
...
Next: review [form core patterns](/docs/v8/forms/patterns), [shared state](/docs/v8/guides/shared-state), or [navigation guards](/docs/v8/guides/navigation).
