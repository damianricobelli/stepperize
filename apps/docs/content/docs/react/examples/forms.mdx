...
<Tabs groupId="forms-install" items={["Conform", "React Hook Form", "TanStack Form"]} defaultIndex={0}>
  <Tab value="Conform">
...
<Tabs groupId="forms-hook" items={["Conform", "React Hook Form", "TanStack Form"]} defaultIndex={0}>
  <Tab value="Conform">
...
<Tabs groupId="forms-preview" items={["Conform", "React Hook Form", "TanStack Form"]} defaultIndex={0}>
  <Tab value="Conform">
    <ConformReactPreview />
  </Tab>
  <Tab value="React Hook Form">
...
<Tabs groupId="forms-full" items={["Conform", "React Hook Form", "TanStack Form"]} defaultIndex={0}>
  <Tab value="Conform">
