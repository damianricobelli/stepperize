...
## 1. Define your steps (and get Scoped / useStepper)
...
<Tabs groupId="scoped-define" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
...
<Tabs groupId="scoped-wrap" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
...
## 3. Render content per step (flow.switch / flow.when)
...
<Tabs groupId="scoped-content" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
...
## 4. Add navigation (next / prev / reset)
...
<Tabs groupId="scoped-nav" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
...
## 5. Optional: initial step, metadata, or local scope only on one global step

<Tabs groupId="scoped-optional" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
...
<Tabs groupId="scoped-preview" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
    <ScopedPreview />
  </Tab>
  <Tab value="Multi-scoped">
...
<Tabs groupId="scoped-full" items={["Single scope", "Multi-scoped"]} defaultValue={0}>
  <Tab value="Single scope">
