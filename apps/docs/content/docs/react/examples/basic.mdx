...
### 2. Wrap with Scoped and Stepper.Root

`Scoped` provides the stepper context. `Stepper.Root` gives you the stepper via a render prop. Use `orientation="horizontal"` (default) for a horizontal layout.
