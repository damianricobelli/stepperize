...
The `useStepper` hook returns the stepper instance with a structured API: **state**, **navigation**, **lookup**, **flow**, and **metadata**. Use it with or without the [`Scoped`](./scoped) component.
