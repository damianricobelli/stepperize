---
title: Installation
description: How to install and set up shadcn-stepper in your project
---
  ...
  <Step>
    ...
    const defineStepper = <const Steps extends Stepperize.Step[]>(
      ...
      return {
        ...
        StepperTitle,
        StepperDescription,
        StepperPanel: ({ children, asChild, ...props }) => {
    ...
    namespace Stepper {
      ...
      > & {
        ...
        StepperTitle: (props: AsChildProps<"h4">) => React.ReactElement;
        StepperDescription: (props: AsChildProps<"p">) => React.ReactElement;
        StepperPanel: (props: AsChildProps<"div">) => React.ReactElement;
        StepperControls: (props: AsChildProps<"div">) => React.ReactElement;
      };
...
You can find more components and blocks in this [section](/docs/react/shadcn/components-and-blocks).
