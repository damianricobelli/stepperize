...
`defineStepper` is the core function for creating a customizable stepper. It generates the necessary hooks and utilities for building your stepper UI and managing its state.
