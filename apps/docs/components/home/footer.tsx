	...
	return (
		<footer className="bg-gray-1 border-t border-gray-3 py-32 px-4 sm:px-6 lg:px-8 relative">
			...
			>
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					<motion.div className="col-span-1 md:col-span-2" variants={itemVariants}>
						...
						<p className="text-gray-11 mb-4 max-w-md">
							A lightweight, flexible and type-safe library for creating intuitive step-by-step experiences with minimal
							boilerplate and maximum control.
						</p>
					...
					<motion.div variants={itemVariants}>
						...
						<ul className="space-y-2">
							<motion.li whileHover={{ x: 5 }}>
								<a href="/docs/react" className="text-gray-11 hover:text-white transition-colors">
									Getting Started
								</a>
							</motion.li>
							<motion.li whileHover={{ x: 5 }}>
								<a href="/docs/react/api-references/define" className="text-gray-11 hover:text-white transition-colors">
									API Reference
								</a>
							</motion.li>
							<motion.li whileHover={{ x: 5 }}>
								<a href="/docs/react/examples/basic" className="text-gray-11 hover:text-white transition-colors">
									Examples
								</a>
							</motion.li>
						</ul>
				...
				>
					<p className="text-gray-11 text-sm">&copy; {new Date().getFullYear()} Stepperize. All rights reserved.</p>
				</motion.div>
			</motion.div>
		</footer>
	);
