...
This is an example of full use of `@stepperize/react`, built with `shadcn/ui` and `cva`
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    export function Basic() {
      ...
      return (
        <div className="flex w-full flex-col gap-4 border border-gray-4 rounded-lg p-4">
          <Stepper
            steps={steps}
