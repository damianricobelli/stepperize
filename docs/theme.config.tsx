...
const logo = (
	<span className="font-bold text-xl text-gray-12 inline-flex items-center gap-2">
		<Waypoints />
		Stepperize
	</span>
);
	...
	head: function useHead() {
		...
		return (
			<>
				...
				<meta
					name="og:description"
					content="Make beautiful steppers with Stepperize. 100% customizable, accessible, and easy to use."
				/>
			...
			<div className="flex w-full flex-col items-center sm:items-start">
				<div>
					<a
						...
						href="https://vercel.com?utm_source=stepperize.vercel.app"
					>
